...
class Enrollments():
    ...
    async def __aenter__(self):
        ...
        self.enrollments = Queue(send_enrollments)
        return self

    async def __aexit___(self, *exc):
        """Flush the queue"""
    ...
    async def enroll(self, section_school_code, school_uid, delete, admin=False):
        """Create an enrollment and put in in the queue"""
        enrollment = {
    ...
    async def send_enrollments(self, enrollments):
        """Sends a request for a group of enrollments"""
